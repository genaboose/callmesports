      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="contact" className="py-20 bg-slate-50">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <p className="mt-4 text-lg text-slate-600 text-center">
              Sag uns kurz, was du erreichen willst – wir melden uns mit dem passenden Coach.
            </p>

            <form
              className="mt-10 grid gap-4 rounded-2xl bg-white p-6 border"
              action="https://formspree.io/f/xanbrkbk"
              method="POST"
            >
              {/* Spam-Honeypot */}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <select name="goal" className="rounded-xl border px-4 py-3">
                ...
                <select name="level" className="rounded-xl border px-4 py-3">
              ...
              <textarea
                name="message"
                rows={5}
                placeholder="Zeitfenster, Ort (Home/Gym), Equipment, Verletzungen, Wünsche…"
                className="rounded-xl border px-4 py-3"
              />

              <input type="hidden" name="_subject" value="Neue Coaching-Anfrage (CallMeSports)" />

              <button
                type="submit"
                className="mt-2 px-6 py-3 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 transition"
              >
                Anfrage senden
              </button>

              <p className="text-xs text-slate-500">
                Mit Absenden stimmst du zu, dass wir dich per E-Mail kontaktieren.
              </p>
            </form>
          </div>
        </section>
